...
/** updateSign POST /api/user/update/sign */
export async function updateSignUsingPOST(options?: { [key: string]: any }) {
  return request<API.BaseResponseboolean>('/api/user/update/sign', {
    method: 'POST',
    ...(options || {}),
  });
}
